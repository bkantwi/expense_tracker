...
<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('categories.store') }}" class="bg-white rounded-lg shadow-sm p-6 space-y-4">
                @csrf
                ...
                <div>
                    ...
                    <textarea name="description" rows="4"
                              class="mt-1 w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">{{ old('description') }}</textarea>
                </div>
